            ...
            $(function() {
                $('#cursos-table').DataTable({
                    ...
                    columns: [
                        ...
                        {
                            data: "id",                                 /* No funciona por que lleva al show no al destroy... */
                            "render": function (data) {
                                return "<form method='DELETE' action='/cursos/" + data + "'><button type='submit' class='btn btn-danger'><span class='glyphicon glyphicon-remove-sign'></span> Borrar</button></form>";
                            }
                        },
                    ]
                });
